  ...
  return (
    <div>
      <div className='flex justify-center gap-4 sm:gap-8 my-10 relative'>
        ...
        {/* menu of differnt categories using {Map and useState and Css} for interactive  and add animation for menu filters like All, Technology using motion package*/}
